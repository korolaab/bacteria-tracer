...
from keras.layers import Input,MaxPooling2D, Conv2D,Dropout,Conv2DTranspose, concatenate,LeakyReLU, BatchNormalization
...
def crop_from_photo(image,size,shift,mode=None):
...
pretrained_weights=None):
    ...
    u6 = Conv2DTranspose(n_filters*2, (3, 3), strides=(2, 2), padding='same') (c3)
